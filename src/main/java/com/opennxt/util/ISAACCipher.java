...
public class ISAACCipher {
	 ...
	 */
	/**
	 * DEBUG ONLY: -Dopennxt.isaac.disable=true makes this cipher emit a
	 * keystream of zeros, so every opcode on the wire is plaintext.
	 *
	 * This is the server half of a matched pair and is USELESS ALONE - the
	 * client must be patched to do the same, or the two sides disagree and
	 * nothing decodes. On build 949 that patch is a single 3-byte edit:
	 */
