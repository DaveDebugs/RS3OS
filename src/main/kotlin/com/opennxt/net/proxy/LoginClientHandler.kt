...
//                    passthrough.writeAndFlush(msg.copy(rights = 2))
            ...
            // Was e.printStackTrace(): stderr, with nothing saying which
            // upstream connection or which login message it choked on. In the
            // proxy that context is the whole value of the line - two channels
            // are in play and the bare trace named neither.
            logger.error(e) {
